okex
====
[![Go Reference](https://pkg.go.dev/badge/github.com/wfunc/okex.svg)](https://pkg.go.dev/github.com/wfunc/okex)
[![GitHub go.mod Go version of a Go module](https://img.shields.io/github/go-mod/go-version/wfunc/okex.svg)](https://github.com/wfunc/okex)
[![GoReportCard example](https://goreportcard.com/badge/github.com/wfunc/okex)](https://goreportcard.com/report/github.com/wfunc/okex)
[![GitHub license](https://img.shields.io/github/license/wfunc/okex.svg)](https://github.com/wfunc/okex/blob/main/LICENSE)
[![GitHub release](https://img.shields.io/github/release/wfunc/okex.svg)](https://GitHub.com/wfunc/okex/releases/)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
[![CI](https://github.com/wfunc/okex/actions/workflows/main.yml/badge.svg)](https://github.com/wfunc/okex/actions/workflows/main.yml)
[![CodeQL](https://github.com/wfunc/okex/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/wfunc/okex/actions/workflows/codeql-analysis.yml)
[![AutoRelease](https://github.com/wfunc/okex/actions/workflows/release.yml/badge.svg)](https://github.com/wfunc/okex/actions/workflows/release.yml)
...
```bash
go get github.com/wfunc/okex@v1.1.4-alpha
```
...
import (
  ...
  "github.com/wfunc/okex/api"
  "github.com/wfunc/okex/events"
  "github.com/wfunc/okex/events/public"
  ws_public_requests "github.com/wfunc/okex/requests/ws/public"
  "log"
)
...
* To receive websocket events you can choose [RawEventChan](/api/ws/client.go#L25)
  ...
  channels. [More info](https://github.com/wfunc/okex/wiki/Handling-WS-events) 
